...
from SuperAttentionPoint import SuperAttentionPointFrontend
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', type=str, default='tests/FPVfreestyle_Trim.mp4',
                        help='Image directory or movie file or "camera" (for webcam)'
                             '(default: tests/FPVfreestyle_Trim.mp4).')
    parser.add_argument('--weights_path', type=str, default='models/superpoint_magicleap.pth',
                        help='Path to pretrained weights file (default: models/superpoint_magicleap.pth).')
    ...
    parser.add_argument('--model_front', type=str, default='base',
                        help='Model used to compute interest points (default: base) (one of base, attention).')
    ...
    if opt.model_front == "attention":
        modelclass = SuperAttentionPointFrontend
    else:
        modelclass = SuperPointFrontend

    fe = modelclass(weights_path=opt.weights_path,
